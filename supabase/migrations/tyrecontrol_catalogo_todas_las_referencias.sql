...
-- pantalla; eso es lo que pasaba con las seis marcas de aquí.
--
-- Al terminar deja 77 referencias repartidas en 51 de los 76 modelos.
--
...
--   4. Bridgestone   9 }
--      Dunlop        7 } 22 referencias — LISTADOS DE DISTRIBUIDOR, no
--      Michelin      6 }  ficha oficial. Ver el aviso de sus bloques.
--
...
-- ============================================================
-- BLOQUE 8. Michelin — marca, medidas y 12 modelos (lote 03)
-- (tyrecontrol_catalogo_michelin_lote03.sql)
-- ============================================================
...
-- ============================================================
-- BLOQUE 9. Michelin — 6 referencias. OJO: mismo origen que el bloque 7
-- (tyrecontrol_catalogo_referencias_michelin.sql)
-- ============================================================
