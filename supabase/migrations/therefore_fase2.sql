...
-- la consulta de candidatos tiene que cruzar la factura «0000555111» de un
-- correo con la «555111» de un expediente, y traerse a Node todos los
...
begin
  ...
  if thf_normalizar_id('0000555111') is distinct from '555111'
