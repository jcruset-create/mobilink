 ...
 * MISMA forma: `4417KDT` → `4417KBS`, no `[MATRÍCULA]`. Así el reconocedor
 ...
 * «NEUMATICOS EJEMPLO» antes que «NEUMATICOS EJEMPLO, S.L.», la primera se
 ...
 *
 * Un bastidor como `WZ10A2BCDEF345678` encaja también en el patrón de IBAN
