 ...
 *
 *     "ENT-770199-0501234"  →  tiradas 770199 y 0501234  →  núcleo 501234
 *     "0501234"             →  tiradas 0501234           →  núcleo 501234
 *
 ...
 * caso que si no habría que tratar aparte: `0501234/2` tiene núcleo 501234,
...
export type AlbaranNormalizado = {
  ...
  raw: string;
  /** Sólo letras y dígitos, en mayúsculas: `ENT7701990501234`. */
  completo: string;
...
export type ComparacionAlbaran = {
   ...
   * mirarlo: un `0501235` cuando se pidió `0501234` casi nunca es casualidad,
...
export function compararAlbaranes(
   ...
   * 2. Mismo núcleo.
   *
   * Cubre a la vez los ceros a la izquierda (`0501234` y `501234`) y el
   * identificador compuesto (`0501234` dentro de `ENT-770199-0501234`), porque
   ...
   *
   * Pasa con `770199` dentro de `ENT-770199-0501234`, que suele ser un código
