 ...
 *    tabla literal, `GRABAR 9011223344` seguido de `MODIFICAR 9011223344`
...
export type MotivoPuntuacion = {
  ...
  clave: string;
  puntos: number;
  /** Para la pantalla: «misma factura 0000555111». */
  texto: string;
};
 ...
 *
 * Los ceros importan porque el mismo número de factura viaja como `0000555111`
 * en un correo y como `555111` en el siguiente, según quién lo escriba. Y NO se
 * trocea en tiradas de dígitos como se hace con los albaranes (`albaran.ts`):
 * ahí el troceo resuelve prefijos de proveedor (`ENT-770199-0501234`), pero
 ...
 * esto, el expediente acabaría con dos «grabar 501234». El índice único de la
