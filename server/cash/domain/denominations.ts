...
export const DENOMINACIONES_SEMILLA: Omit<Denominacion, "id">[] = [
  { valor: 50000, tipo: "BILLETE", etiqueta: "500 €", piezasPorCartucho: null, activa: true, orden: 1 },
  { valor: 20000, tipo: "BILLETE", etiqueta: "200 €", piezasPorCartucho: null, activa: true, orden: 2 },
  { valor: 10000, tipo: "BILLETE", etiqueta: "100 €", piezasPorCartucho: null, activa: true, orden: 3 },
  { valor: 5000, tipo: "BILLETE", etiqueta: "50 €", piezasPorCartucho: null, activa: true, orden: 4 },
  { valor: 2000, tipo: "BILLETE", etiqueta: "20 €", piezasPorCartucho: null, activa: true, orden: 5 },
  { valor: 1000, tipo: "BILLETE", etiqueta: "10 €", piezasPorCartucho: null, activa: true, orden: 6 },
  { valor: 500, tipo: "BILLETE", etiqueta: "5 €", piezasPorCartucho: null, activa: true, orden: 7 },
  { valor: 200, tipo: "MONEDA", etiqueta: "2 €", piezasPorCartucho: 25, activa: true, orden: 8 },
  { valor: 100, tipo: "MONEDA", etiqueta: "1 €", piezasPorCartucho: 25, activa: true, orden: 9 },
  { valor: 50, tipo: "MONEDA", etiqueta: "0,50 €", piezasPorCartucho: 25, activa: true, orden: 10 },
  { valor: 20, tipo: "MONEDA", etiqueta: "0,20 €", piezasPorCartucho: 25, activa: true, orden: 11 },
  { valor: 10, tipo: "MONEDA", etiqueta: "0,10 €", piezasPorCartucho: 50, activa: true, orden: 12 },
  { valor: 5, tipo: "MONEDA", etiqueta: "0,05 €", piezasPorCartucho: 50, activa: true, orden: 13 },
  { valor: 2, tipo: "MONEDA", etiqueta: "0,02 €", piezasPorCartucho: 50, activa: true, orden: 14 },
  { valor: 1, tipo: "MONEDA", etiqueta: "0,01 €", piezasPorCartucho: 50, activa: true, orden: 15 },
];
