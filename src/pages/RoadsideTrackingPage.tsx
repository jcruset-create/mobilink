  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <header className="bg-[#16213e] px-6 py-3 flex items-center justify-center">
        <img src="/logo_full_horizontal.png" alt="Mobilink Assist" style={{height: 80, maxWidth: "100%", objectFit: "contain"}} />
      </header>
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <div className="mt-2 text-sm font-semibold text-slate-500">
                {(assistance.esRemolque || !assistance.plate) && assistance.plateRemolque
                  ? `Remolque ${assistance.plateRemolque}${assistance.plate ? ` · Tractora ${assistance.plate}` : ""}`
