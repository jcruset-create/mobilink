    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-900 text-slate-100">
        <div className="w-full max-w-sm rounded-2xl bg-slate-800 p-8 shadow-xl text-center">
          ...
          <h2 className="text-lg font-bold text-slate-100 mb-2">Revisa tu email</h2>
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-900 text-slate-100">
      <div className="w-full max-w-sm rounded-2xl bg-slate-800 p-8 shadow-xl">
        <h1 className="text-xl font-black text-slate-100 mb-1">Mobilink Almacén</h1>
        <p className="text-sm text-slate-500 mb-6">Acceso con enlace mágico</p>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="mt-1 w-full rounded-lg border border-slate-600 bg-slate-900 px-3 py-2 text-sm text-slate-100 outline-none focus:ring-2 focus:ring-sky-600"
            />
          </div>
          ...
          <button
            ...
            className="w-full rounded-xl bg-sky-600 py-2.5 text-sm font-bold text-white hover:bg-sky-500 disabled:opacity-50"
          >
