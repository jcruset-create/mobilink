...
import { CalendarClock, Home, LayoutDashboard, Menu, X } from "lucide-react";
import logoPresencia from "../../../assets/logo-presencia.png";

const LINKS = [
  { to: "/presencia", label: "Dashboard", icon: LayoutDashboard, exact: true },
  { to: "/presencia/fichajes", label: "Fichajes", icon: CalendarClock },
];
...
export default function PresenciaLayout({ title, subtitle, actions, children }: Props) {
