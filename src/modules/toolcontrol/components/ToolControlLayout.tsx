...
import logoToolControl from "../../../assets/logo-toolcontrol.png";

const LINKS = [
  { to: "/toolcontrol", label: "Dashboard", icon: LayoutDashboard, exact: true },
  { to: "/toolcontrol/herramientas", label: "Herramientas", icon: Wrench },
  { to: "/toolcontrol/maquinas", label: "Máquinas", icon: Cog },
  { to: "/toolcontrol/movimientos", label: "Movimientos", icon: ArrowLeftRight },
  { to: "/toolcontrol/mantenimiento", label: "Mantenimiento", icon: ClipboardCheck },
  { to: "/toolcontrol/inventario", label: "Inventario", icon: ClipboardCheck },
  { to: "/toolcontrol/incidencias", label: "Incidencias", icon: AlertTriangle },
  { to: "/toolcontrol/ubicaciones", label: "Ubicaciones", icon: MapPin },
  { to: "/toolcontrol/categorias", label: "Categorías", icon: Tags },
];
...
export default function ToolControlLayout({ title, subtitle, actions, children }: Props) {
