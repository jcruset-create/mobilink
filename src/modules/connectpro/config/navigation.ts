...
import {
  ...
  Receipt, UserCog, ScrollText, Settings, Handshake, Brain, type LucideIcon,
} from "lucide-react";
...
export const CONNECT_NAV: ConnectNavItem[] = [
  ...
  { key: "inteligencia", path: "inteligencia", label: "Centro de Inteligencia", icon: Brain, minRole: "analyst" },
