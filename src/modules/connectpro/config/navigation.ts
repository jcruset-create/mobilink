...
import {
  ...
  Receipt, UserCog, ScrollText, Settings, type LucideIcon,
} from "lucide-react";
...
export const CONNECT_NAV: ConnectNavItem[] = [
  ...
  { key: "nueva", path: "nueva", label: "Nueva asistencia", icon: PlusCircle, minRole: "operator", phase: "F2" },
  ...
  { key: "incidencias", path: "incidencias", label: "Incidencias", icon: AlertTriangle, minRole: "operator", phase: "F2" },
