...
function NuevaActuacion({
  ...
  async function guardar() {
    if (importeMal) {
      setError("El importe no se entiende. Escríbelo como 272,83.");
      return;
    }
    setGuardando(true);
    try {
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        <TextField label="Albarán" value={albaran} onChange={setAlbaran} placeholder="0806295" />
        <TextField label="Importe (€)" value={importe} onChange={setImporte} placeholder="272,83" />
        <TextField
