...
class OfflineStore {
  ...
  /// Intenta vaciar la cola. Se llama al recuperar red y periodicamente.
  /// Se detiene ante un error real de servidor (para mantener el orden);
  /// ante un error de red simplemente reintenta mas tarde.
  static Future<void> flush() async {
    for (final entry in pending()) {
      ...
      try {
        ...
        // Sin red u otro fallo: paramos aqui, se reintentara luego.
        offline.value = true;
        return;
      }
    }
